...
// Brought from aio repository
// https://github.com/angular/angular/blob/main/aio/src/app/shared/scroll-spy.service.ts
// Integrated to scroll service as my requirement is simple enough
...
export class ScrollSpyService {
  ...
  private lastMaxScrollTop: number = 0;
  ...
  private getTopOffset(): number  {
    ...
    if (!this._topOffset) {
      ...
      this._topOffset = ((toolbar && toolbar.clientHeight) || 0) + this.topMargin;
    }
