...
another internal link example: [Move to Examples2](doc/example2)<!--rehype:class=internal-link-->

### Anchor Links

Anchor link will also working as same link syntax.

anchor link: [Move to Links](doc/example1#links)<!--rehype:class=internal-link-->

another anchor link example: [Move to Images](doc/example1#images)<!--rehype:class=internal-link-->

anchor link for another page: [Move to Examples2 - Links](doc/example2#links)<!--rehype:class=internal-link-->
