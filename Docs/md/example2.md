...
For anguler's limitation, we need to introduce another syntax to show internal link(link within the site).
 ...
 `internal-link` is the css class to show internal link as a different style compare to external links.
  ...
  Following link: [Move to Example1](doc/example1)<!--rehype:class=internal-link--> will move to initial home screen of this site

  another example for own link [Move to Example2(own screen)](doc/example2)<!--rehype:class=internal-link-->
